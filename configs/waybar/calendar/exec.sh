...
case $1 in
    ...
    #Monday
    monday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $2}' | grep $today); TEXT="Mo" ;;
    ...
    #Tuesday
    tuesday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $3}' | grep $today); TEXT="Tu" ;;
    ...
    # Wednesday
    wednesday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $4}' | grep $today); TEXT="We" ;;
    ...
    # Thursday
    thursday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $5}' | grep $today); TEXT="Th" ;;
    ...
    # Friday
    friday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $6}' | grep $today); TEXT="Fr" ;;
    ...
    # Saturday
    saturday ) tgl=$($HOME/.config/waybar/calendar/calendar | awk '{print $7}' | grep $today); TEXT="Sa" ;;
